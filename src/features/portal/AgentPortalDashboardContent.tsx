...
const hotlineMetricCards: readonly MetricCard[] = [
  { label: '总呼叫量', value: '3099', note: '组平均 3099', primary: true },
  { label: '解决率', value: '20.00% ', emphasis: '(21/102)', note: '组平均 20.00%', danger: true, primary: true },
  { label: '满意度', value: '20.00% ', emphasis: '(21/102)', note: '组平均 20.00%', danger: true, primary: true },
  { label: '参评率', value: '20.00% ', emphasis: '(21/102)', note: '组平均 20.00%', danger: true },
  { label: '总通话时长', value: '4:20:10', note: '组平均 4:20:10' },
  { label: '平均通话时长', value: '00:01:20', note: '组平均 00:01:20' },
  { label: '总ACW时长', value: '01:20:40', note: '组平均 00:01:20', danger: true },
  { label: '平均ACW时长', value: '00:00:40', note: '组平均 00:01:20' },
  { label: '小休时长', value: '01:20:40', note: '组平均 00:01:20', danger: true },
  { label: '质检平均分', value: '85/3条', note: '组平均 90', primary: true },
];

const hotlineYesterdayMetricCards: readonly MetricCard[] = [
  { label: '总呼叫量', value: '2876', note: '组平均 2950', primary: true },
  { label: '解决率', value: '22.10% ', emphasis: '(35/158)', note: '组平均 21.40%', danger: true, primary: true },
  { label: '满意度', value: '21.80% ', emphasis: '(34/158)', note: '组平均 22.60%', danger: true, primary: true },
  { label: '参评率', value: '23.50% ', emphasis: '(37/158)', note: '组平均 22.90%', danger: true },
  { label: '总通话时长', value: '4:02:55', note: '组平均 4:15:08' },
  { label: '平均通话时长', value: '00:01:18', note: '组平均 00:01:22' },
  { label: '总ACW时长', value: '01:12:30', note: '组平均 00:01:18', danger: true },
  { label: '平均ACW时长', value: '00:00:36', note: '组平均 00:01:18' },
  { label: '小休时长', value: '01:05:20', note: '组平均 00:01:18', danger: true },
  { label: '质检平均分', value: '86/4条', note: '组平均 89', primary: true },
];

const hotlineMonthlyMetricCards: readonly MetricCard[] = [
  { label: '总呼叫量', value: '28690', note: '组平均 27420', primary: true },
  { label: '解决率', value: '23.80% ', emphasis: '(682/2869)', note: '组平均 22.50%', danger: true, primary: true },
  { label: '满意度', value: '24.60% ', emphasis: '(705/2869)', note: '组平均 23.10%', danger: true, primary: true },
  { label: '参评率', value: '25.20% ', emphasis: '(723/2869)', note: '组平均 24.30%', danger: true },
  { label: '总通话时长', value: '42:18:35', note: '组平均 39:25:10' },
  { label: '平均通话时长', value: '00:01:31', note: '组平均 00:01:25' },
  { label: '总ACW时长', value: '10:52:40', note: '组平均 09:43:18', danger: true },
  { label: '平均ACW时长', value: '00:00:46', note: '组平均 00:00:42' },
  { label: '小休时长', value: '09:15:20', note: '组平均 08:42:10', danger: true },
  { label: '质检平均分', value: '88/26条', note: '组平均 91', primary: true },
];

const onlineMetricCards: readonly MetricCard[] = [
  { label: '总接待量', value: '3099', note: '组平均 3099', primary: true },
  { label: '解决率', value: '20.00%', note: '组平均', danger: true, primary: true },
  { label: '满意度', value: '20.00%', note: '组平均', danger: true, primary: true },
  { label: '参评率', value: '20.00%', note: '组平均', danger: true },
  { label: '首次响应时长', value: '00:00:4', note: '组平均' },
  { label: '平均响应时长', value: '00:00:4', note: '组平均' },
  { label: '总沟通时长', value: '4:20:10', note: '组平均' },
  { label: '平均沟通时长', value: '00:01:2', note: '组平均' },
  { label: '总后处理时长', value: '01:20:4', note: '组平均', danger: true },
  { label: '平均后处理时长', value: '00:00:4', note: '组平均' },
  { label: '小休时长', value: '01:20:4', note: '组平均', danger: true },
  { label: '质检平均分', value: '85/3条', note: '组平均 90', primary: true },
];

const onlineYesterdayMetricCards: readonly MetricCard[] = [
  { label: '总接待量', value: '2852', note: '组平均 2920', primary: true },
  { label: '解决率', value: '21.40%', note: '组平均 22.10%', danger: true, primary: true },
  { label: '满意度', value: '22.80%', note: '组平均 23.40%', danger: true, primary: true },
  { label: '参评率', value: '23.20%', note: '组平均 24.00%', danger: true },
  { label: '首次响应时长', value: '00:00:5', note: '组平均' },
  { label: '平均响应时长', value: '00:00:6', note: '组平均' },
  { label: '总沟通时长', value: '4:08:55', note: '组平均' },
  { label: '平均沟通时长', value: '00:01:3', note: '组平均' },
  { label: '总后处理时长', value: '01:12:38', note: '组平均', danger: true },
  { label: '平均后处理时长', value: '00:00:5', note: '组平均' },
  { label: '小休时长', value: '01:10:24', note: '组平均', danger: true },
  { label: '质检平均分', value: '87/5条', note: '组平均 90', primary: true },
];

const onlineMonthlyMetricCards: readonly MetricCard[] = [
  { label: '总接待量', value: '25890', note: '组平均 24120', primary: true },
  { label: '解决率', value: '22.80%', note: '组平均 21.60%', danger: true, primary: true },
  { label: '满意度', value: '24.20%', note: '组平均 23.80%', danger: true, primary: true },
  { label: '参评率', value: '25.10%', note: '组平均 24.40%', danger: true },
  { label: '首次响应时长', value: '00:00:5', note: '组平均 00:00:6' },
  { label: '平均响应时长', value: '00:00:6', note: '组平均 00:00:7' },
  { label: '总沟通时长', value: '39:42:15', note: '组平均 36:18:40' },
  { label: '平均沟通时长', value: '00:01:4', note: '组平均 00:01:3' },
  { label: '总后处理时长', value: '08:45:2', note: '组平均 07:58:4', danger: true },
  { label: '平均后处理时长', value: '00:00:5', note: '组平均 00:00:4' },
  { label: '小休时长', value: '08:18:4', note: '组平均 07:42:5', danger: true },
  { label: '质检平均分', value: '89/28条', note: '组平均 91', primary: true },
];
